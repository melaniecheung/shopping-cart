    ...
    <div className='bg-[#F8F8F8] w-full flex flex-col justify-between h-[90vh]'>
      <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
        <div className='flex flex-col justify-center md:items-start w-full px-10'>
          ...
          <h1 className='text-[60px] font-bold text-[#8F00FF]'>2022</h1>
          ...
          <Link to='/products' className='py-3 px-8 text-white font-bold bg-[#8F00FF] sm:w-[60%] my-4 rounded-md mt-10 hover:bg-white hover:text-[#8F00FF] border-2 border-[#8F00FF] transition' style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}
            >Shop Now
          </Link>
        </div>
        <div>
